...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\GOTNI\Documents\Python\modelsPy\DjangoModels\.env'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\GOTNI\Documents\Python\modelsPy\DjangoModels\.env\Scripts\deactivate.nu'
